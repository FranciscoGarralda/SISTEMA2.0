      ...
      <div className="flex items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                currentPage === item.id
                  ...
                  : 'text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700'
              }`}
            >
        ...
        <div className="flex items-center space-x-3">
          ...
          {isAuthenticated && (
            <button
              onClick={onLogout}
              className="p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-red-500 transition-colors"
              title="Cerrar sesión"
            >
              <LogOut size={18} />
            </button>
